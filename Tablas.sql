...
CREATE SEQUENCE FIDE_CONTRATISTAS_SEQ
START WITH 1
INCREMENT BY 1;
...
CREATE OR REPLACE TRIGGER FIDE_CONTRATISTAS_ID_TRG
BEFORE INSERT ON FIDE_CONTRATISTAS_TB
FOR EACH ROW
BEGIN
    :NEW.CONTRATISTA_ID := FIDE_CONTRATISTAS_SEQ.NEXTVAL;
END;
/
...
-- Trigger para la tabla FIDE_CONTRATISTAS_TB
CREATE OR REPLACE TRIGGER FIDE_CONTRATISTAS_CREADO_MODIFICADO_POR_TRG
BEFORE INSERT OR UPDATE ON FIDE_CONTRATISTAS_TB
FOR EACH ROW
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR := USER;
...
CREATE OR REPLACE TRIGGER FIDE_CONTRATISTAS_FECHA_CREADO_MODIFICADO_POR_TRG
BEFORE INSERT OR UPDATE ON FIDE_CONTRATISTAS_TB
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
CREATE OR REPLACE TRIGGER FIDE_CONTRATISTAS_ACCION_TRG
BEFORE INSERT OR UPDATE ON FIDE_CONTRATISTAS_TB
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
-- Trigger para la tabla FIDE_RESPOSABLES_TB
...
DROP SEQUENCE FIDE_CONTRATISTAS_SEQ;
